//package com.example.t2305m_wcd.factory;
//
...
//
//    public static ClassDAO createClassDAO(Connection connection) {
//        return new ClassDAOImpl(connection);
//    }
//
//    public static StudentDAO createStudentDAO(Connection connection) {
//        return new StudentDAOImpl(connection);
//    }
//
//    public static SubjectDAO createSubjectDAO(Connection connection) {
